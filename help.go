...
var commandHelp = map[string]cmdHelp{
	...
	"clear-refs": {
		...
		Usage:    "borz clear-refs [--tab <id>]",
		Examples: []string{"  borz clear-refs", "  borz clear-refs --tab ab1c"},
		Notes:    "Clears only the visual overlay. The latest snapshot refs remain actionable.",
	},
	"screenshot": {
