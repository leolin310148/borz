...
var snapshotTool = mcp.NewTool("browser_snapshot",
	...
	mcp.WithBoolean("showRefs", mcp.Description("Override ref overlay visibility for this call. Omit to use ~/.borz/settings.json (visible when unset). Hidden refs are still returned and actionable.")),
